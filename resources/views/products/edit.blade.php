    ...
    <div class="container">
        ...
        <form method="post" action="{{ route('product.update', ['product' => $product]) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nom_produit" name="nom_produit" placeholder="Nom du Produit" value="{{ $product->nom_produit }}">
            </div>

            <div class="form-group">
                <label for="categorie">Catégorie</label>
                <input type="text" class="form-control" id="categorie" name="categorie" placeholder="Catégorie" value="{{ $product->categorie }}">
            </div>

            <div class="form-group">
                <label for="conseils_utilisation">Conseils d'Utilisation</label>
                <input type="text" class="form-control" id="conseils_utilisation" name="conseils_utilisation" placeholder="Conseils d'Utilisation" value="{{ $product->conseils_utilisation }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="adresse" name="adresse" placeholder="Adresse" value="{{ $product->adresse }}">
            </div>
