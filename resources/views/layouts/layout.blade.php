...
<head>
    ...
    <!-- CSS Files -->
    @vite('resources/assets/css/material-dashboard.css') <!-- Changed to use Vite -->
...
<body class="g-sidenav-show  bg-gray-200">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="{{ Vite::asset('resources/assets/img/team-2.jpg') }}" class="avatar avatar-sm me-3" alt="team_member">
                                            </div>
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="{{ Vite::asset('resources/assets/img/small-logos/logo-spotify.svg') }}" class="avatar avatar-sm bg-gradient-dark me-3" alt="spotify_logo">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="text-sm font-weight-normal mb-1">
    ...
    <script src="{{ Vite::asset('resources/assets/js/material-dashboard.min.js') }}"></script>
    </body>
